...
<body class="mvg-page">
            ...
            <ul class=" nav justify-content-center">
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li><a class="dropdown-item" href="#">Goal, Mission and
                                Vision</a> </li>
    ...
    <div class="main-container">
        <div class="banner" style="background-image: url(../src/css/images/banner/banner13.webp);">
        </div>
        <div class="container-fluid school-desc">
            <div class="row align-items-center">
                <div class="col-sm">
                    <h3 class="text-green text-uppercase fw-semibold" data-aos="fade-up-right">Goal</h3>
                    <h5 class="text-green fw-light mb-5" data-aos="fade-in">To see to it that every student is
                        responsible for their self. development and that the school is responsible for providing an
                        environment which allows such development.</h5>
                </div>
                <div class="col-sm">
                    <div class="img-gallery" data-aos="fade-up-left">
                        <img src="../src/css/images/IMG_20230822_194908.webp" alt="image">
                        <img src="../src/css/images/IMG_20230822_195029.webp" alt="image">
                        <img src="../src/css/images/IMG_20230822_194952.webp" alt="image">
                        <img src="../src/css/images/IMG_20230822_194847.webp" alt="image">
                    </div>
                </div>
            </div>
        </div>
        <div class="banner" style="background-image: url(../src/css/images/banner/banner5.webp);">
        </div>
        <div class="container-fluid mis-vis-school">
            <div class="row">
                <div class="col-sm border border-success m-2 p-3" data-aos="fade-up">
                    <h3 class="text-uppercase fw-semibold" data-aos="fade">Mission</h3>
                    <h5 class="fw-light mb-5" data-aos="fade-up">To be able to recognize and fulfill
                        our
                        special
                        obligation and commitments as a dependable educational institution. The San Francisco de Sales
                        School is devoted to provide every student with the best education to enhance their acquired
                        proficiency which would emulate their virtues and become:</h5>
                    <h5>
                        <ul>
                            <li data-aos="fade-up" data-aos-anchor-placement="center-bottom" data-aos-duration="1000">
                                <span>S</span> - ervice
                                Oriented
                            </li>
                            <li data-aos="fade-up" data-aos-anchor-placement="center-bottom" data-aos-duration="1500">
                                <span>F</span> - aithful to
                                God and Country
                            </li>
                            <li data-aos="fade-up" data-aos-anchor-placement="center-bottom" data-aos-duration="2000">
                                <span>D</span> - ignified
                            </li>
                            <li data-aos="fade-up" data-aos-anchor-placement="center-bottom" data-aos-duration="2500">
                                <span>S</span> - piritual
                                and
                            </li>
                            <li data-aos="fade-up" data-aos-anchor-placement="center-bottom" data-aos-duration="3000">
                                <span>S</span> - killful in
                                life
                            </li>
                        </ul>
                    </h5>
                </div>
                <div class="col-sm border border-success m-2 p-3 text-end" data-aos="fade-up">
                    <h3 class="text-uppercase fw-semibold" data-aos="fade">Vision</h3>
                    <h5 class="fw-light mb-5" data-aos="fade-up">To be an institution known and
                        respected in
                        designing the educational formation intended for the Virtuous, Country-Loving and Globally
                        Competitive Franciscan Students that will lead them for a lifetime success.</h5>
                </div>
            </div>
        </div>
                    ...
                    <div class="row justify-content-center">
                        <div class="col-sm-4 col-md-3 footer-item">
                            ...
                            <ul>
                                ...
                                <li><a href="#">Goal, Mission and Vision</a></li>
