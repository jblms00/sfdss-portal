...
<body class="admin-side-page manage-student-page" data-admin-id="<?php echo $user_data['user_id']; ?>"
                    ...
                    <div class="table-responsive">
                        <div class="search-container text-center my-4">
                            ...
                            <button type="button" class="remove-selected-btn d-none" id="removeSelected"
                                data-bs-toggle="modal" data-bs-target="#modalRemoveSelectedSections">
                                Remove selected
                            </button>
                ...
                <form id="addStudentsForm">
                    ...
                    <div class="modal-body container-fluid">
                        <div class="d-flex justify-content-center">
                            <button type="button" class="modal-opt-btn add-student-btn" id="addInput">
                                Add More Students
                            </button>
                        </div>
