...
<body class="admin-process-page">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li class="nav-item dropend">
                            ...
                            <ul class="dropdown-menu">
                                <li>
                                    <a class="dropdown-item" href="#">Governing Bodies</a>
                                </li>
                                <li>
    ...
    <div class="main-container">
        ...
        <div class="container-fluid school-desc text-green">
            <div class="row align-items-center">
                <div class="col-sm">
                    <h2 class="text-uppercase fw-semibold" data-aos="flip-down">Implementing, Advisory and
                        Consultative Bodies</h2>
                    <h5 class="mt-4 fw-light" data-aos="fade-right"><span class="fw-semibold fst-italic">Principal's
                            Council.</span> It
                        serves as a
                        consultative
                        body for matters that need not to be brought to Administrators' Council. It is composed of the
                        Principal, Vice-Principal, Prefect of Students, Prefect of Activities, Guidance Head and other
                        consultants appointed by the Principal.</h5>
                    <h5 class="mt-4 fw-light" data-aos="fade-right"><span class="fw-semibold fst-italic">Board of
                            Discipline.</span> This board is composed of administrators, a faculty representative, and a
                        student representative. It reviews and decides on all disciplinary cases of students that merit
                        dismissal and/or expulsion which are brought to its attention and in other cases which the
                        Principal might deem necessary to consult. The decision of the Board in such cases is final.
                    </h5>
                    <h5 class="mt-4 fw-light" data-aos="fade-right"><span class="fw-semibold fst-italic">Board of
                            Admission and Re-admission</span> The board is headed by the Principal and composed of
                        school teachers and administrators appointed by him. The members formulate and implement
                        policies and procedures for the admission and re-admission of students.</h5>
                    <h5 class="mt-4 fw-light" data-aos="fade-right"><span class="fw-semibold fst-italic">Committee on
                            Awards and Scholarships</span> Composed of administrators and faculty members appointed by
                        the Principal whose function is to formulate and implement guidelines for determining honors,
                        awards and scholarships to deserving students.</h5>
                </div>
            </div>
        </div>
