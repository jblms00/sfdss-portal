            ...
            <ul class=" nav justify-content-center">
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li><a class="dropdown-item" href="#">Alma Mater Song</a></li>
    ...
    <div class="main-container">
        ...
        <div class="container-fluid school-desc">
            <div class="row align-items-center">
                <div class="col-sm">
                    <h2 class="text-green text-uppercase fw-semibold" data-aos="flip-down">SFDSS Hymn</h2>
                    <h5 class="text-green fw-normal" data-aos="zoom-in">To thee our countries seeds of hope</h5>
                    <h5 class="text-green fw-normal" data-aos="zoom-in">Shall we forever be abode.</h5>
                    <h5 class="text-green fw-normal" data-aos="zoom-in">To nurture in the heart of this land we love
                        Seeds of courage and justice and truth</h5>
                    <h5 class="text-green fw-normal" data-aos="zoom-in">To climb every hill and mountain, and reap for
                        the fruit of glory</h5>
                    <h5 class="text-green fw-normal" data-aos="zoom-in">Hail, San Francisco de Sales, Hail o hail</h5>
                    <h5 class="text-green fw-normal" data-aos="zoom-in">(Thy name a message of greatebess reign) 2x</h5>
                </div>
                <div class="col-sm text-center">
                    <img src="../src/css/images/09-23-2023-1.webp" class="box-shadow" style="width: 100%" alt="image"
                        data-aos="fade">
                </div>
            </div>
        </div>
                    ...
                    <div class="row justify-content-center">
                        <div class="col-sm-4 col-md-3 footer-item">
                            ...
                            <ul>
                                ...
                                <li><a href="#">Alma Mater Song</a></li>
