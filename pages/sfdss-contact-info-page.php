...
<body class="contact-info-page">
    ...
    <div class="main-container">
        ...
        <div class="container-fluid school-map">
            <div class=" row">
                <div class="col" data-aos="zoom-in">
                    <h2 class="text-center text-green fw-bold text-uppercase">Location</h2>
                </div>
            </div>
            <div class="row">
                <div class="col-sm mb-4" data-aos="fade">
                    <div class="school-map">
                        <img src="../src/css/images/map/school-map-1.webp" alt="image">
                    </div>
                </div>
                <div class="col-sm mb-4" data-aos="fade">
                    <div class="school-map">
                        <img src="../src/css/images/map/school-map-2.webp" alt="image">
                    </div>
                </div>
            </div>
            <div class="row my-4">
                <div class="col text-center">
                    <h3 class="fw-bold text-uppercase text-green" data-aos="zoom-in-up">San Francisco De Sales School of
                        San Pedro
                        Laguna Inc.</h3>
                    <h5 data-aos="zoom-in-up">88 A Mabini St, San Pedro,
                        4023 Laguna</h5>
                    <h5 data-aos="zoom-in-up">Tel. No. 8808-40-77</h5>
                </div>
            </div>
        </div>
